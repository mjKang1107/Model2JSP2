...
num1, num2 값이 둘다 양수 인지 판별(t/f)? ${(param.num1 > 0) && (param.num2 > 0) }<br>
num1, num2 값이 둘다 양수 인지 판별(t/f)? ${(param.num1 gt 0) && (param.num2 gt 0) }<br>
...
<!-- 
	...
	()
	x? a:b
	empty : 값이 null이거나, 컬렉션의 사이즈가 0인 경우 true
	---------------------------------------------
	+ - * /(div) %(mod)
	&&(and) ||(or) !(not)
	----------------------------------------------
