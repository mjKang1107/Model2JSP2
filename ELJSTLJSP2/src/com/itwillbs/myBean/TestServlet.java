...
public class TestServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String tel = "010-6505-6595";
	
		//java페이지기 때문에 jsp내장객체는 없음
		//=>HttpServletRequest req 객체 사용(jsp-request객체)
		//request영역에 저장
		req.setAttribute("tel", tel);
		
		//사용자 객체 생성
		MemberDTO kang = new MemberDTO();
		kang.setUserName("강백호");
		kang.setUserGender("여자");
		kang.setUserEmail("kang@naver.com");
		
		//request 영역에 저장
		req.setAttribute("userInfo", kang);
